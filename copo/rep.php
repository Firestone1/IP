...
<?php
    ...
    while($row = mysqli_fetch_array($result)){
       ...
       $po1=unserialize($row[8]);
       $po2=unserialize($row[9]);
       $po3=unserialize($row[10]);
       $po4=unserialize($row[11]);
       $po5=unserialize($row[12]);
       $po6=unserialize($row[13]);
       $po7=unserialize($row[14]);
       $po8=unserialize($row[15]);
       $po9=unserialize($row[16]);
       $po10=unserialize($row[17]);
       $po11=unserialize($row[18]);
       $po12=unserialize($row[19]);
       $pso1=unserialize($row[20]);
       $pso2=unserialize($row[21]);
       $pso3=unserialize($row[22]);
       $pso4=unserialize($row[23]);
       $course=$row[1];
       $sem=$row[6];
       $year=$row[7];
       $year1=$year+1;
      ...
      <h2>&nbsp;course name : '.$course_nm.'</h2>
      <pre>     course code : '.$course.'</pre>
      <pre>     Sem         : '.$sem.'</pre>
