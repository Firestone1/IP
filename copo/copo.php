...
<?php
   ...
   $uid=$course_cd.$cay;
    ...
    $query="insert into test (uid,dept,sem,cay,course_nm,course_cd,co1,co2,co3,co4,b1,b2,b3,b4) values ('$uid','$dept','$sem','$cay','$course_nm','$course_cd','$co1','$co2','$co3','$co4','$b1','$b2','$b3','$b4');";
...
<html>
   <h3 class="w3-bar w3-teal">
    ...
    <table class='w3-center w3-striped copo' border='1'>
      ...
      <input type='hidden' name='co1' value=<?php echo '"'.$co1.'"';?>>
      <input type='hidden' name='co2' value=<?php echo '"'.$co2.'"';?>>
      <input type='hidden' name='co3' value=<?php echo '"'.$co3.'"';?>>
      <input type='hidden' name='co4' value=<?php echo '"'.$co4.'"';?>>
      </form>
